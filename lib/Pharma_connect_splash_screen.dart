...
Future<void> main() async {
  ...
  await Supabase.initialize(
    ...
    anonKey: 'sb_publishable_5x5OzXiIOF8Rly6Odizb0g_rvQ6ABDe',
  );

  // If a session was already active (app reopened while still logged
  // in), pull that user's saved cart down in the background.
  if (Supabase.instance.client.auth.currentSession != null) {
    CartModel.instance.loadFromSupabase();
  }
